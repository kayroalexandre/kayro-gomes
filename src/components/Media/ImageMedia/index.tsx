...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  return (
    <picture
      className={cn(
        pictureClassName,
        // O <img fill> do Next exige um parent posicionado. Sem isso o Next
        // emite warn "fill and parent element with invalid 'position'" e a
        // imagem renderiza com 0 de altura.
        //
        // - fill: o <picture> ocupa o container inteiro (parent deve prover
        //   a altura, ex: `<div className="relative h-...">`).
        // - !fill: o <picture> vira referência de tamanho para o <img>
        //   com width/height explícitos.
    ...
    >
      <NextImage
        ...
        // Usamos `empty` em vez de `blur` para evitar o SVG placeholder
        // com feFlood/feGaussianBlur que o Next renderiza enquanto a imagem
        // carrega — ele produz um flash azulado/esverdeado em fundos escuros.
        // Para LCP rápido, a hero image usa `priority`; o resto fica `lazy`.
        placeholder="empty"
        priority={priority}
        quality={85}
        loading={loading}
